...
//Array e Objeto deve ser informado manualmente o tipo
interface Item {
  id: number;
  title: string;
  image_url: string;
...
const CreatPoint = () => {
  ...
  const [selectPosition, setSeletecPosition] = useState<[number, number]>([0,0]);
    ...
    <div id="page-create-point">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <fieldset>
          ...
          >
            <TileLayer 
              attribution='&anp;copy <a href="http://osm.org/copyright">OpenStreetMap</a> contributors'
